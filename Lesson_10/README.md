...
2. В отчете Allure вы увидите:
   ...
   - **Шаги теста**: Описание действий, которые выполнялись для проведения тестирования.
   - **Результат**: Успешное выполнение или ошибка с указанием фактического результата.